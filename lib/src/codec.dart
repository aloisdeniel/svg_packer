...
// INFO: adds the `onCommandBegin` callback on vector listener.

import 'dart:convert';
import 'dart:typed_data';

import 'package:vector_graphics_codec/src/fp16.dart' as fp16;
...
class VectorGraphicsCodec {
  ...
  DecodeResponse decode(
    ...
    while (buffer.hasRemaining) {
      ...
      listener?.onCommandBegin.call(buffer._position); // INFO: Added logic
      switch (type) {
